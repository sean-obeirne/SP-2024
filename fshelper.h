...
#include "ramdisk.h"
#if 1  // BEG variables & macros

// Uncomment for debugging info, such as current function or success status
////////////////
// #define DEBUG
////////////////

// Pause time definitions
#define SLEEP_FACTOR 2 	// on-the-fly adjustment of delay times
#define STEP 1
#define FIVER 5
...
#define INF_PAUSE 10000 * SLEEP_FACTOR

// Useful ASCII codes
#define MAX_ASCII_CHAR 127 	// 128+ seems invalid
#define FILLED_CIRCLE 7 	// for file printing
#define OPEN_CIRCLE 9 		// for directory printing

typedef struct DirectoryEntry DirectoryEntry;
typedef struct DeconstructedPath DeconstructedPath;
typedef enum EntryType EntryType;
#endif // END Variables & macros
...
/////////////////////
/*
** Show header information, a key for files vs directory circles
